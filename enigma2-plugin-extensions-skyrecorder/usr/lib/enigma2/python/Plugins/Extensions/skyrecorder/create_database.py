...
def buildSkydb(target=None,rebuild=False,backup=True):
	...
	print "{0} createing table: added".format(debugprefix)
	...
	print "{0} createing table: channel".format(debugprefix)
	...
	print "{0} createing table: skip".format(debugprefix)
	...
	print "{0} createing table: groups".format(debugprefix)
	...
	print "{0} createing table: genre".format(debugprefix)
	...
	print "{0} createing table: genregroup".format(debugprefix)
	...
	print "{0} createing table: events".format(debugprefix)
	...
	print "{0} createing table: eventslist".format(debugprefix)
	...
	print "{0} createing table: eventdetails".format(debugprefix)
	...
	print "{0} createing table: eventcover".format(debugprefix)
	...
	### Tigger
	print "{0} createing trigger".format(debugprefix)
	...
	channelset = (
		...
		('National Geopgraphic Wild','NatGeo Wild','False',0,87),
		...
		('National Geopgraphic Wild HD','Nat Geo Wild HD','False',0,88),
...
# start here
buildSkydb(rebuild=True,backup=False)
